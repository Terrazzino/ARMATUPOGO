...
-- CreateEnum
CREATE TYPE "EstadoEvento" AS ENUM ('BORRADOR', 'PUBLICADO', 'EN_CURSO', 'COMPLETADO', 'CANCELADO');

-- CreateEnum
CREATE TYPE "EstadoContratacion" AS ENUM ('PENDIENTE', 'NEGOCIANDO', 'ACORDADO', 'CANCELADO', 'COMPLETADO', 'RECHAZADO');
...
CREATE TABLE "contrataciones" (
    ...
    "status" "EstadoContratacion" NOT NULL DEFAULT 'PENDIENTE',
