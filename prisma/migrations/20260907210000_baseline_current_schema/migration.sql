...
CREATE TABLE "eventos" (
    ...
    "venue_name" TEXT,
    "city" TEXT,
    "required_projects_count" INTEGER NOT NULL DEFAULT 1,
...
-- CreateIndex
CREATE INDEX "postulaciones_event_id_musician_id_status_idx" ON "postulaciones"("event_id", "musician_id", "status");
...
-- CreateIndex
CREATE INDEX "contrataciones_musician_id_status_idx" ON "contrataciones"("musician_id", "status");

-- CreateIndex
CREATE INDEX "contrataciones_event_id_status_idx" ON "contrataciones"("event_id", "status");
...
-- AddForeignKey
ALTER TABLE "contrataciones" ADD CONSTRAINT "contrataciones_postulation_id_fkey" FOREIGN KEY ("postulation_id") REFERENCES "postulaciones"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- Domain CHECK constraints not expressible in the Prisma schema
ALTER TABLE "eventos" ADD CONSTRAINT "eventos_starts_before_ends_check" CHECK (ends_at > starts_at);
ALTER TABLE "valoraciones" ADD CONSTRAINT "valoraciones_score_range_check" CHECK (score BETWEEN 1 AND 5);
